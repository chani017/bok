(function () {
  ...
  const palette = [
    '#000000', '#FFFFFF', '#FF97D0', '#125603', '#1F6BED', '#F4FF1E',
    '#FF1EC7', '#518DFF', '#6E1221', '#E76290', '#0759A2', '#5196E8',
    '#0D9488', '#FBBF24', '#6366F1', '#10B981', '#FCC5C6', '#06B6D4',
    '#8B5CF6', '#84CC16', '#F97316', '#0EA5E9', '#D946EF', '#34D399'
  ];
  const textColorByBg = {
    '#000000': '#FFFFFF', '#FFFFFF': '#000000', '#C3F380': '#125603',
    '#125603': '#FF97D0', '#1F6BED': '#F4FF1E', '#F4FF1E': '#1F6BED',
    ...
    '#10B981': '#6E1221', '#FCC5C6': '#D13F13', '#06B6D4': '#6E1221',
