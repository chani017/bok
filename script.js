(function () {
  ...
  // 이미지(5x5 그리드)에서 추출한 25개 배경·글자색 조합
  const palette = [
    '#FF1493', '#4169E1', '#DAA520', '#2C2C2C', '#FFD700',
    '#006D5B', '#50C878', '#4B0082', '#FF4500', '#8E4585',
    '#87CEEB', '#1E90FF', '#FF1493', '#00BFFF', '#32CD32',
    '#3D2463', '#FFD700', '#5F9EA0', '#B0E0E6', '#000080',
    '#98FB98', '#E6E6FA', '#FF1493', '#0000CD', '#E63946', '#000000', '#FFFFFF'
  ];
  const textColorByBg = {
    '#FF1493': '#FFFF00', '#4169E1': '#FFB6C1', '#DAA520': '#8B00FF',
    '#2C2C2C': '#CC5500', '#FFD700': '#000000', '#006D5B': '#7FFFD4',
    '#50C878': '#2F4F4F', '#4B0082': '#E6E6FA', '#FF4500': '#FFB6C1',
    '#8E4585': '#228B22', '#87CEEB': '#800020', '#1E90FF': '#FF9F00',
    '#00BFFF': '#DC143C', '#32CD32': '#8A2BE2', '#3D2463': '#98FB98',
    '#5F9EA0': '#FFD700', '#B0E0E6': '#000080', '#000080': '#FFFFFF',
    '#98FB98': '#191970', '#E6E6FA': '#FFB6C1', '#0000CD': '#FFDAB9',
    '#E63946': '#FFFF00', '#000000': '#FFFFFF', '#FFFFFF': '#000000'
  };

  function getTextColor(bgHex) {
    return textColorByBg[bgHex] || '#000';
  }
